...
def get_movies(category):
    ...
    with urllib.request.urlopen(get_movie_url) as url:
        get_movies_data = url.read() #read the response from the API
        get_movies_response = json.loads(get_movies_data) #convert the json response to a python dictionary
